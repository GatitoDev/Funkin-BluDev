...
class ClassHUD extends FlxTypedGroup<FlxBasic>
{
	...
	public function new()
	{
		...
		/*
		// For fun
		if (PlayState.SONG.song.toLowerCase() == 'developer')
		{
			// BF is happy
			FlxTween.tween(iconP1, {y: iconP2.y + 7}, 0.4, {ease: FlxEase.elasticInOut, type: PINGPONG});
			// He moves little because he is tired
			FlxTween.tween(iconP2, {y: iconP2.y + 5}, 0.6, {ease: FlxEase.elasticInOut, type: PINGPONG});
		}
		*/
