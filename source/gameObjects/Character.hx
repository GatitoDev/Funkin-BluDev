...
class Character extends FNFSprite
{
	...
	public function setCharacter(x:Float, y:Float, character:String):Character
	{
		...
		switch (curCharacter)
		{
			...
			case 'gato':
				barColor = 0xFF66CCFF;
				tex = Paths.getSparrowAtlas('characters/gato');
				frames = tex;

				animation.addByPrefix('idle', "Gato IDLE Dance", 24, false);
				animation.addByPrefix('singUP', "Gato UP Note", 24, false);
				animation.addByPrefix('singDOWN', "Gato DOWN Note", 24, false);
				animation.addByPrefix('singLEFT', 'Gato LEFT Note', 24, false);
				animation.addByPrefix('singRIGHT', 'Gato RIGHT Note', 24, false);
			...
			case 'bf-blue':
				barColor = 0xFF307AD1;
				frames = Paths.getSparrowAtlas('characters/bf-blue');
