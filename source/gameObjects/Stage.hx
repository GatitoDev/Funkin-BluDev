	...
	public function new(curStage)
	{
		...
		switch (curStage)
		{
			...
			case 'emptytop': // developed week
				...
				var floor:FNFSprite = new FNFSprite(760, 1100).loadGraphic(Paths.image('backgrounds/' + curStage + '/floor'));
				...
				laptop = new FNFSprite(930, 665).loadGraphic(Paths.image('backgrounds/' + curStage + '/laptop'));
				laptop.antialiasing = true;
				laptop.updateHitbox();
				laptop.scrollFactor.set(0.9, 0.9);
				laptop.active = false;

				// add to the final array
				add(laptop);

				moon = new FNFSprite(1425, 560).loadGraphic(Paths.image('backgrounds/' + curStage + '/moon'));
				moon.antialiasing = true;
				moon.updateHitbox();
				moon.scrollFactor.set(0.9, 0.9);
				moon.active = false;
