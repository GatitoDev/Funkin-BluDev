...
class Main extends Sprite
{
	...
	// Credits
	public static var creditsG:String = 'GatitoDev'; // Programmer, animator, artist, charter
	public static var creditsD:String = 'DELETE-THAT'; // Musician
